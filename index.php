        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Univera</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">Where dreams are built.</h2>
                    <div data-aos="fade-up" data-aos-delay="800">
                        <a href="#about" class="btn-get-started scrollto ">Get Started</a>
                    </div>
                </div>
                <div class="col-lg-5 order-2 hero-img">
                    <img src="./img/girl.png" class="img-fluid animated" alt="">
                </div>
            </div>
        </div>
